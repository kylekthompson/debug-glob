...
// ripped from https://github.com/yargevad/filepathx/blob/master/filepathx.go
// modified to print debug statements
...
func (globs Globs) Expand() ([]string, error) {
	...
	for _, glob := range globs {
		...
		for _, match := range matches {
			log.Printf("delegating to filepath.Glob for %q", match+glob)
